...
{#await getEmbed() then embed}
  {#if embed && enabled}
    ...
    <div
      ...
      class={[
        "border-border fixed top-6 left-6 border-2 bg-white text-left font-sans text-base tracking-normal text-black shadow-lg transition duration-300 ease-in-out",
